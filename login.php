...
if ($_GET["lang"] == "en") {
  ...
  echo '</header>';
  echo '<form action="login.php?lang=en" method="POST">';
  echo '<h2>Login</h2>';
  ...
  echo '<div class="col-sm-12">';
  if ($log == 'failed' || $log == 'pass')
  echo '<span class="text-danger">Login error</span>';
  echo '</div>';
  echo '</div>';
  echo '</form>';
} else {
  ...
  echo '<a href="login.php?unauth&lang=en" id="en_flag"><img src="https://www.geonames.org/flags/x/uk.gif" width="40px" height="20px"></a>';
  echo '</header>';
  echo '<form action="login.php?lang=sk" method="POST">';
  ...
  echo '<div class="col-sm-12">';
  if ($log == 'failed' || $log == 'pass')
    echo '<span class="text-danger">Chyba prihlásenia</span>';
  echo '</div>';
  echo '</div>';
  echo '</form>';
}
